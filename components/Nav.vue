<template>
  <div>
    <nav id="header" class="w-full z-30 top-0 border-b fixed bg-white py-1">
      <div
      ...
      >
        ...
        <div class="order-1 md:order-2">
          ...
          >
            ENDLESS
            <svg
              class="fill-current text-gray-800 mx-2"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <div class="order-2 md:order-3 flex items-center" id="nav-content">
          ...
          >
            <svg
              class="fill-current hover:text-black cursor-pointer"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            <span
              class="absolute cursor-pointer top-[17px] right-[139px] text-xs"
              >{{ cartLength }}</span
            >
          </span>
        </div>
